(defproject clojuregex-two "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "clojuregex-two.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main clojuregex-two.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "clojuregex-two.core/on-figwheel-reload"}

                :compiler {:main clojuregex-two.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clojuregex_two.js"
                          ...
                          {:test
                           {:source-paths ["src/cljs" "test/cljs"]
                            ...
                            {:output-to "resources/public/js/compiled/testable.js"
                             :main clojuregex-two.test-runner
                             :optimizations :none}}}}}
